...
while user_score < target_score and comp_score < target_score:
    ...
    print()
    print(f"👔 Game Over - You Are TIED 👔"
          f"🏆 User: {user_score} points | Computer: {comp_score} points 🏆 ")
    print()

# print()
# print(f"Final Scores - User ({user_score}) | Computer ({comp_score}")
